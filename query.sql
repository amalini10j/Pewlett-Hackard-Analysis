...
-- This list includes the manager's employee number, first name, last name, and their starting 
...
-- Getting retirees only from Sales department
select * from dept_info where dept_name = 'Sales';
